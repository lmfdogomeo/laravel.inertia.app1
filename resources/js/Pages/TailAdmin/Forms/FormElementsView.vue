<script setup>
import BreadcrumbDefault from '@/Components/TailAdmin/Breadcrumbs/BreadcrumbDefault.vue'
import CheckboxFive from '@/Components/TailAdmin/Forms/Checkboxes/CheckboxFive.vue'
import CheckboxFour from '@/Components/TailAdmin/Forms/Checkboxes/CheckboxFour.vue'
import CheckboxOne from '@/Components/TailAdmin/Forms/Checkboxes/CheckboxOne.vue'
import CheckboxThree from '@/Components/TailAdmin/Forms/Checkboxes/CheckboxThree.vue'
import CheckboxTwo from '@/Components/TailAdmin/Forms/Checkboxes/CheckboxTwo.vue'
import DatePickerOne from '@/Components/TailAdmin/Forms/DatePicker/DatePickerOne.vue'
import DatePickerTwo from '@/Components/TailAdmin/Forms/DatePicker/DatePickerTwo.vue'
import DefaultCard from '@/Components/TailAdmin/Forms/DefaultCard.vue'
import SwitchFour from '@/Components/TailAdmin/Forms/Switchers/SwitchFour.vue'
import SwitchOne from '@/Components/TailAdmin/Forms/Switchers/SwitchOne.vue'
import SwitchThree from '@/Components/TailAdmin/Forms/Switchers/SwitchThree.vue'
import SwitchTwo from '@/Components/TailAdmin/Forms/Switchers/SwitchTwo.vue'
import DefaultLayout from '@/Layouts/DefaultLayout.vue'

import { ref } from 'vue'
import MultiSelect from '@/Components/TailAdmin/Forms/MultiSelect.vue'
import SelectGroupOne from '@/Components/TailAdmin/Forms/SelectGroup/SelectGroupOne.vue'
