...
const menuGroups = ref([
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Merchants", route: "admin.merchants.index" },
          { label: "Add New", route: "admin.merchants.create" },
        ],
      },
      {
        icon: `
        ...
        children: [
          ...
          { label: "Add New", route: "admin.products.create" },
        ],
      },
      {
        icon: `
    ...
    menuItems: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Not Found Error", route: "error404" },
        ],
      },
    ],
  },
    ...
    menuItems: [
      {
        ...
        label: "Charts",
        route: "#",
        children: [{ label: "Basic Chart", route: "chart.basic" }],
      },
      {
        icon: `<svg
                  class="fill-current"
        ...
        route: "#",
        children: [
          { label: "Alerts", route: "element.alerts" },
          { label: "Buttons", route: "element.buttons" },
        ],
      },
      {
        icon: `<svg
