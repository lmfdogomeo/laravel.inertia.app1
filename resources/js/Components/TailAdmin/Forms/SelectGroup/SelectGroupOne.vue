...
<template>
  <div>
    ...
    <div class="relative z-20 bg-white dark:bg-form-input">
      <span class="absolute z-30 -translate-y-1/2 top-1/2 left-4">
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
      ...
      <select
        ...
        class="relative z-20 w-full px-12 py-3 transition bg-transparent border rounded outline-none appearance-none border-stroke focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input"
      >
