        ...
        <div class="relative z-20 inline-block w-full">
          <div class="relative flex flex-col items-center">
            <div @click="open" class="w-full">
              <div
                class="flex py-2 pl-3 pr-3 mb-2 transition border rounded outline-none border-stroke focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input"
              >
                <div class="flex flex-wrap flex-auto gap-3">
                  <template v-for="index in selected" :key="index">
                    ...
                    >
                      <div class="flex-initial max-w-full">{{ options[index].text }}</div>
                      <div class="flex flex-row-reverse flex-auto">
                        <div @click="remove(index)" class="pl-2 cursor-pointer hover:text-danger">
                          <svg
                            class="fill-current"
                            role="button"
                            width="12"
